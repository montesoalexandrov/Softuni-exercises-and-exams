...
namespace CarSalesman
{
    public class StartUp
    {
        ...
        private static Engine ReadEngineData()
        {
        ...
        private static Car ReadCarData(List<Engine> engines)
        {
            var inputData = Console.ReadLine().Split(new char[] { ' ' }, StringSplitOptions.RemoveEmptyEntries);
        ...
        private static void PrintResult(Queue<Car> cars)
        {
